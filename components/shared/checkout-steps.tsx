...
const CheckOutSteps = ({ current = 0 }) => {
    return (<div className="flex-between flex-col space-x-2 space-y-2 mb-10 md:flex-row">
        {/* Step 1 */}
        {['User Login', 'Shipping Address', 'Payment Method', 'Place Order'].map((step, index) => (
            ...
            <React.Fragment key={step}>
                ...
                {step !== 'Place Order' && <div className={cn('w-10 h-0.5 bg-secondary', index < current ? 'bg-secondary' : 'bg-gray-300')}></div>}
